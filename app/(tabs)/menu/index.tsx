...
const menuActions: MenuAction[] = [
  ...
  },
  {
    ...
    iconTint: '#85581A',
    cardClass: 'border-[#eadfcc] bg-[#fdfbf7]',
    iconClass: 'bg-[#f5ebd6]',
  },
  {
    id: 'about',
              ...
              {menuActions.map((action) => (
                ...
                >
                  <View className={`mr-3 h-9 w-9 items-center justify-center rounded-[10px] ${action.iconClass}`}>
                    {action.isSymbol && action.symbolName ? (
                      <IconSymbol name={action.symbolName as any} size={18} color={action.iconTint} />
                    ) : (
